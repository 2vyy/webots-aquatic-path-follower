...
- When the physics engine causes the boat to roll slightly, the 2D plane that the Lidar scans upon can become angled. A tilt threshold filter suppresses scan publishing when roll/pitch exceeds 10 degrees.

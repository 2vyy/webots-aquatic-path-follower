...
class Path:
    ...
    def __init__(self):
        ...
        self.y = []
        self.yaw = []
        self.directions = [] # 1:forward, -1:backward
...
# --- Reeds Shepp Formulae (CSC, CCC, etc) ---
# (Keeping these standard functions collapsed for brevity, 
#  they remain unchanged from your original upload)
...
def generate_path(q0, q1, max_curvature, step_size):
    ...
    paths = []
    path_functions = [left_straight_left, left_straight_right,
